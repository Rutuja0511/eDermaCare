    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yesAppointment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ConfirmAppointment.this, "Appointment has been booked successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ConfirmAppointment.this, ConfirmedAppointments.class);
        ...
        noAppointment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ConfirmAppointment.this, "Appointment has not been booked", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ConfirmAppointment.this, IncomingAppointments.class);
                intent.putExtra("user_email", userId);
                startActivity(intent);
            }
        });
